              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <select id="inputState" name="nova_unidade" class="form-control">
                    <option value="<?php echo $dados_selecionado['unidade'] ?>" selected require> <?php echo $dados_selecionado['unidade'] ?> </option>
                ...
                <div class="form-group col-md-6">
                  ...
                  <select id="inputState" name="novo_tipo_produto" class="form-control">
                    <option value="<?php echo $dados_selecionado['tipo'] ?>" selected require><?php echo $dados_selecionado['tipo'] ?></option>
